...
echo 00) Wyjœcie
echo.
set /p CHOICE="Wybierz operacjê (0-6): "
...
REM ------------------------------------------------------------------------
REM Sekcja 7 KONFIG – zmiana œcie¿ek katalogów
:KONFIG
cls
...
REM ------------------------------------------------------------------------
REM Sekcja 8 FOLDERY – szybkie otwieranie katalogów
:FOLDERY
cls
...
REM ------------------------------------------------------------------------
REM Sekcja 9 KONIEC – zakoñczenie programu
:KONIEC
cls
